...
import atomic_reactor.util as atomic_utils
...
def mock_url_responses(docker_registry, test_images, worker_digests, version='2'):
    (flexmock(atomic_utils)
...
class TestGroupManifests(object):
    ...
    @pytest.mark.parametrize(('goarch', 'worker_annotations', 'valid'), [
        ({}, {}, False),
        ({}, {'x86_64': X86_ANNOTATIONS}, False),
        ({'x86_64': 'amd64'}, {}, False),
        ({'x86_64': 'amd64'}, {'x86_64': X86_ANNOTATIONS}, True),
    ...
    def test_basic_group_manifests(self, tmpdir, use_secret, goarch,
        ...
        mock_url_responses([DOCKER0_REGISTRY], test_images, [X86_DIGESTS], version)
